...
{
	m_tabSetupMove.InsertItem(0, "Load / Angle / Btm1");
	m_tabSetupMove.InsertItem(1, "Top1 / Top2 / Btm2 / Buffer");
	m_tabSetupMove.InsertItem(2, "Sort / Good / NG / Tray");
...
void CSetupMoveDlg::Save_MoveDataForAllParam() 
{
	m_pSetupMoveTab1Dlg->Save_MoveDataForAll();
	m_pSetupMoveTab2Dlg->Save_MoveDataForAll();
	m_pSetupMoveTab3Dlg->Save_MoveDataForAll();
}
